...
/**
 * This Adpater class adapts data from remote database and binds them to a visual from.
 */
public class MyAdapter extends FirebaseRecyclerAdapter<Book,MyAdapter.MyViewHolder>
{
    ...
    protected void onBindViewHolder(@NonNull MyViewHolder Holder, int position, @NonNull final Book model)//this method binds the view creted by onCreteViewHolder with data from model class(Book.java).
    {
        ...
        Holder.Image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new DetailsFragment(model.getTitle(),model.getPrice(),model.getUrl())).addToBackStack(null).commit();
            }
        });
    }
    @NonNull
